class NodesController < ApplicationController
  ...
  def index
    ...
    respond_to do |format|
      ...
      format.json { render json: @tree_node}
    end
    ...
    respond_to do |format|
      ...
      if (!valid)
        ...
        if @node.save
          ...
          puts Node.is_complete
          @tree_node=Node.json_tree(tree).to_json
          format.html { redirect_to action: "index", notice: 'Node was successfully created.' }
          format.json { render json: @tree_node, status: :created}
        else
          format.html { render :new }
  ...
  def update
    ...
    respond_to do |format|
      if @node.update(node_params)
        ...
        format.html { redirect_to action: "index", notice: 'Node was successfully updated.' }
        format.json { render json: @tree_node }
      else
